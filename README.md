...
晚间状态更新（2026-09-18）：v8用户已训练完成，提交53.5740，仍未超过v4的55.6000；v7 best_map50.pth确认52.4010。重新官方下载已安全刷新datasets，全部6000图像及官方新版标签与之前内容相同，1709/291划分和已有清洗修订保留。最新审计为runs/dataset_cleaning/official_refresh_20260918_214843，旧完整数据和缓存保存在其before。用户预测入口已选v8 best_map50.pth、1280。详见 [完成复盘与下一轮方向](docs/v8完成复盘与官方下载刷新.md)。下方“候选/尚未训练”等为早前实施阶段；本轮没有替换新架构或自动运行模型任务。
