...
2026-09-18 晚间更新：用户已完成v8并反馈53.5740，v7 best_map50.pth为52.4010。当前用户预测选择v8 best_map50.pth、1280。官方下载刷新已落位1709/291，全部图像及新版标签新旧内容相同，审计official_refresh_20260918_214843保留完整before；main.py仅改DATA_AUDIT。没有自动模型测试/评估/训练/推理；截图经验与下一轮候选见docs/v8完成复盘与官方下载刷新.md。禁止用下方历史默认值覆盖用户新选择，不实现多权重投票。
